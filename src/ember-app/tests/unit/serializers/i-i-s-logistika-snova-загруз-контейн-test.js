...
moduleForModel('i-i-s-logistika-snova-загруз-контейн', 'Unit | Serializer | i-i-s-logistika-snova-загруз-контейн', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-загруз-контейн',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
