...
moduleForModel('i-i-s-logistika-snova-т-ч-инф-о-конт', 'Unit | Serializer | i-i-s-logistika-snova-т-ч-инф-о-конт', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-т-ч-инф-о-конт',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
