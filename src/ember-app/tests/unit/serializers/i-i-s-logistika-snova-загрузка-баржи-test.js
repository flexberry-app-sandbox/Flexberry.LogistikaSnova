...
moduleForModel('i-i-s-logistika-snova-загрузка-баржи', 'Unit | Serializer | i-i-s-logistika-snova-загрузка-баржи', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-загрузка-баржи',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
