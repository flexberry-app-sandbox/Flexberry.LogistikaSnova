...
moduleForModel('i-i-s-logistika-snova-т-ч-инф-о-грузе', 'Unit | Serializer | i-i-s-logistika-snova-т-ч-инф-о-грузе', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-т-ч-инф-о-грузе',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
