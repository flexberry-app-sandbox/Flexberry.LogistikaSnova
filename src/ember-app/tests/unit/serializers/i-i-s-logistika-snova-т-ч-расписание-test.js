...
moduleForModel('i-i-s-logistika-snova-т-ч-расписание', 'Unit | Serializer | i-i-s-logistika-snova-т-ч-расписание', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-т-ч-расписание',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
