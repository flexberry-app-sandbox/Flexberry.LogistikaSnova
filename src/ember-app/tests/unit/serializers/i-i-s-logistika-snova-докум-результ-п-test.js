...
moduleForModel('i-i-s-logistika-snova-докум-результ-п', 'Unit | Serializer | i-i-s-logistika-snova-докум-результ-п', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-logistika-snova-докум-результ-п',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
